[
  ...
  # REMOVED - library function patterns were unused (PLT was properly configured)
  ...
  # ===========================================
  # UNUSED PATTERNS - REMOVED IN SPRINT 28
  # ===========================================
  
  # The following patterns were removed because dialyzer reported them as unused filters:
  # - Ash Domain framework functions (wormhole_operations_api)
  # - Phoenix LiveView framework functions 
  # - String.Chars protocol functions
  #
  # If these errors reappear in future dialyzer runs, they can be re-added.
  # This cleanup was done to maintain accuracy in our ignore patterns.
