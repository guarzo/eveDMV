defmodule EveDmvWeb.CoreComponents do
  ...
  optimized for developer happiness and help maintain consistency across your
  application. You can customize them to your needs.

  The default components use Tailwind CSS, a utility-first CSS framework.
  See the [Tailwind CSS documentation](https://tailwindcss.com) to learn how
  to customize them or feel free to swap in another CSS framework altogether.
  ...
  def flash(assigns) do
    ...
    <div
      ...
      role="alert"
      class={[
        "fixed top-2 right-2 max-w-sm w-full z-50 rounded-lg p-3 ring-1",
  ...
  Icons are provided by [heroicons](https://heroicons.com). See `icon` for usage.
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(EveDmvWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(EveDmvWeb.Gettext, "errors", msg, opts)
    end
  end
