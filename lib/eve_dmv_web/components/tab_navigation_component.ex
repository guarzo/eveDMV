defmodule EveDmvWeb.Components.TabNavigationComponent do
  ...
  defp tab_button_class(variant, is_active, is_disabled) do
    base_classes = "px-3 py-2 text-sm font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500"
  ...
  defp count_badge_class(variant, is_active) do
    base_classes = "inline-flex items-center justify-center px-2 py-1 text-xs font-bold rounded-full min-w-[1.25rem]"
    
    color_classes = case variant do
      "pills" ->
  ...
  defp tab_icon_path(icon) do
    case icon do
      "chart-line" ->
        Phoenix.HTML.raw(~s{<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 12l3-3 3 3 4-4M8 21l4-4 4 4M3 4h18M4 4h16v12a1 1 0 01-1 1H5a1 1 0 01-1-1V4z" />})
      "crosshairs" ->
        Phoenix.HTML.raw(~s{<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 2v20M2 12h20M12 8a4 4 0 100 8 4 4 0 000-8z" />})
      "brain" ->
        Phoenix.HTML.raw(~s{<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" />})
      "users" ->
        Phoenix.HTML.raw(~s{<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197m13.5-9a2.5 2.5 0 11-5 0 2.5 2.5 0 015 0z" />})
      "shield" ->
        Phoenix.HTML.raw(~s{<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />})
      _ ->
        Phoenix.HTML.raw(~s{<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v10a2 2 0 002 2h8a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" />})
    end
  end
end