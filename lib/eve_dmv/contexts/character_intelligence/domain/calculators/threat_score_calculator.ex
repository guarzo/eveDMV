defmodule EveDmv.Contexts.CharacterIntelligence.Domain.ThreatScoring.Calculators.ThreatScoreCalculator do
  @moduledoc """
  ...
  """
  @spec calculate_comprehensive_score(Types.combat_data(), keyword()) ::
  ...
  @spec calculate_dimensional_scores(Types.combat_data()) :: Types.dimensional_scores()
  ...
  @spec calculate_weighted_threat_score(Types.dimensional_scores()) :: float()
  ...
  @spec determine_threat_level(float()) :: Types.threat_level()
  ...
  @spec calculate_recent_activity_score(Types.combat_data()) :: Types.score_component()
  defp calculate_recent_activity_score(%{killmails: []} = _combat_data) do
    %{
  ...
  @spec analyze_activity_trend([map()]) :: :stable | :increasing | :decreasing
  defp analyze_activity_trend(killmails) when length(killmails) < 5, do: :stable

  defp analyze_activity_trend(killmails) when is_list(killmails) do
  ...
  @spec calculate_confidence(Types.dimensional_scores()) :: float()
