defmodule EveDmv.Contexts.Intelligence.Resources.CharacterProfile do
  ...
  attributes do
    ...
    # Activity metrics
    attribute :activity_level, :atom, constraints: [one_of: [:minimal, :low, :moderate, :active, :very_active, :hyperactive]]
    ...
    attribute :preferred_gang_size, :atom, constraints: [one_of: [:solo, :small_gang, :medium_gang, :fleet]]
    ...
    attribute :danger_rating, :atom, constraints: [one_of: [:minimal, :low, :moderate, :dangerous, :very_dangerous, :extremely_dangerous]]
    attribute :threat_level, :atom, constraints: [one_of: [:minimal, :low, :moderate, :high, :critical]]
    
    # Classification
    attribute :pilot_type, :atom, constraints: [one_of: [:elite_solo_hunter, :solo_specialist, :fleet_pilot, :gang_specialist, :generalist]]
    attribute :skill_level, :atom, constraints: [one_of: [:novice, :intermediate, :experienced, :veteran, :elite]]
    attribute :primary_activity, :atom, constraints: [one_of: [:inactive, :solo_hunter, :fleet_pilot, :mixed]]
    ...
    attribute :roaming_range, :atom, constraints: [one_of: [:local, :regional, :inter_regional, :nomadic]]
    
    # Security and reputation
    attribute :security_status, :atom, constraints: [one_of: [:criminal, :suspect, :neutral, :positive]]
    ...
    attribute :analysis_confidence, :atom, constraints: [one_of: [:very_low, :low, :medium, :high, :very_high]]
  ...
  actions do
    ...
    create :create do
      ...
      accept [
        ...
        :alliance_id, :alliance_name, :total_kills, :total_losses,
        :kill_death_ratio, :solo_kills, :solo_losses, :solo_ratio,
        :total_isk_destroyed, :total_isk_lost, :isk_efficiency,
        :activity_level, :active_days, :avg_kills_per_week,
        :first_kill_date, :last_kill_date, :avg_gang_size,
        :preferred_gang_size, :gang_participation_ratio,
        :ship_types_used, :favorite_ship_type_id, :favorite_ship_name,
        :capital_usage_ratio, :threat_score, :danger_rating,
        :threat_level, :pilot_type, :skill_level, :primary_activity,
        :timezone_estimate, :predictability_score, :primary_region,
        :active_regions, :roaming_range, :security_status,
        :bounty_value, :faction_warfare_participation,
        :data_quality_score, :analysis_confidence,
        :threat_breakdown, :ship_preferences, :behavioral_patterns,
        :performance_metrics, :notable_patterns
      ]
    ...
    update :update do
      primary? true
      accept [
        :character_name, :corporation_id, :corporation_name,
        :alliance_id, :alliance_name, :total_kills, :total_losses,
        :kill_death_ratio, :solo_kills, :solo_losses, :solo_ratio,
        :total_isk_destroyed, :total_isk_lost, :isk_efficiency,
        :activity_level, :active_days, :avg_kills_per_week,
        ...
        :active_regions, :roaming_range, :security_status,
        :bounty_value, :faction_warfare_participation,
        :data_quality_score, :analysis_confidence, :last_seen,
        :threat_breakdown, :ship_preferences, :behavioral_patterns,
        :performance_metrics, :notable_patterns
      ]
    ...
    update :update_analysis do
      accept [
        :threat_score, :danger_rating, :threat_level, :pilot_type,
        :skill_level, :primary_activity, :predictability_score,
        :data_quality_score, :analysis_confidence,
        :threat_breakdown, :ship_preferences, :behavioral_patterns,
        :performance_metrics, :notable_patterns
      ]
    ...
    update :update_stats do
      accept [
        :total_kills, :total_losses, :kill_death_ratio,
        :solo_kills, :solo_losses, :solo_ratio,
        :total_isk_destroyed, :total_isk_lost, :isk_efficiency,
        :activity_level, :active_days, :avg_kills_per_week,
        :last_kill_date, :avg_gang_size, :preferred_gang_size,
        :gang_participation_ratio, :ship_types_used,
        :favorite_ship_type_id, :favorite_ship_name,
        :capital_usage_ratio, :last_seen
      ]
