defmodule EveDmv.Contexts.Intelligence.Api do
  ...
  # Batch Operations
  defdelegate analyze_characters(character_ids, opts \\ []), to: CharacterAnalyzer, as: :analyze_batch
  defdelegate assess_threats(character_ids, opts \\ []), to: ThreatAssessmentEngine, as: :assess_batch
