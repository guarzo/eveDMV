defmodule EveDmv.Contexts.CombatIntelligence.Domain.BattleAnalysis.Engines.FleetAnalysisEngine do
  ...
  defp calculate_doctrine_confidence(doctrine_matches, ship_analysis) do
    if Enum.empty?(doctrine_matches) do
      ...
      pattern_strength = length(doctrine_matches) / 5.0  # Max 5 possible doctrines
  ...
  defp detect_artillery_doctrine(ship_analysis) do
    ...
    battleship_ratio = Map.get(ship_analysis.breakdown, :battleship, 0) / ship_analysis.total_ships
    battlecruiser_ratio = Map.get(ship_analysis.breakdown, :battlecruiser, 0) / ship_analysis.total_ships
  ...
  defp detect_logistics_heavy(ship_analysis) do
    ...
    logistics_ratio > 0.15  # >15% logistics ships
  end
  ...
  defp is_ewar_ship?(ship_type_id) do
    ...
    ewar_ship_types = [
      # Recon ships
      11_957, 11_959, 11_961, 11_963,
      # ECM ships  
      11_965, 11_969, 11_971, 11_973,
      # Force recon
      12_019, 12_021, 12_023, 12_025
    ]
