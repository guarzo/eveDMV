defmodule EveDmv.Intelligence.StatisticalAnalyzer do
  @moduledoc """
  ...
  def normalize_to_scale(values, scale \\ 100) when is_list(values) do
  ...
  defp assess_correlation_quality(correlations) do
    ...
    total_possible = 6  # Expected correlation types
