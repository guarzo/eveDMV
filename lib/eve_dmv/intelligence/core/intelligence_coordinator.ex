defmodule EveDmv.Intelligence.Core.IntelligenceCoordinator do
  ...
  defp get_basic_analysis(character_id, use_cache) do
    if use_cache do
      ...
      # Use the new behavior interface for character analysis
      CharacterAnalyzer.analyze_with_telemetry(character_id, %{})
    end
  end
  ...
  defp get_vetting_analysis(character_id, use_cache) do
    if use_cache do
      ...
      # Use the new behavior interface for vetting analysis
      WHVettingAnalyzer.analyze_with_telemetry(character_id, %{})
    end
  end
