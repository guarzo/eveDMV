defmodule EveDmv.Eve.ShipGroups do
  ...
  """
  def is_logistics?(group_id) when is_integer(group_id) do
    classification = get_classification(group_id)
  ...
  """
  def is_ewar?(group_id) when is_integer(group_id) do
    classification = get_classification(group_id)
  ...
  def get_role_category(group_id) when is_integer(group_id) do
    cond do
      is_logistics?(group_id) -> :logistics
      is_ewar?(group_id) -> :ewar
