defmodule EveDmv.Platform.Cache.Cache do
  @moduledoc """
  ...
  ## Examples
      ...
      EveDmv.Platform.Cache.put(:hot_data, {:character, 123}, character_data)
      {:ok, data} = EveDmv.Platform.Cache.get(:hot_data, {:character, 123})

      # Cache API response
      EveDmv.Platform.Cache.put(:api_responses, {:esi, :character, 123}, esi_response)

      # Cache analysis result
      EveDmv.Platform.Cache.put(:analysis, {:character_intel, 123}, intel_data)
  """
  alias EveDmv.Core.Utils.Cache
  alias EveDmv.Platform.Cache.CacheSupervisor
