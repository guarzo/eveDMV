defmodule EveDmv.Shared.Intelligence.SourceHandlers.KillmailHandler do
  ...
  def build_timeline(killmails) do
    ...
    |> Enum.map(fn killmail ->
      %{
        ...
        is_capital: capital_kill?(killmail),
        is_pod: pod_kill?(killmail)
      }
    end)
  end
  ...
  defp capital_kill?(killmail) do
    ...
    ship_type_id >= 20_000 && ship_type_id <= 30_000
  end
  ...
  defp count_capital_kills(killmails) do
    Enum.count(killmails, &capital_kill?/1)
  end
  ...
  defp count_pod_kills(killmails) do
    Enum.count(killmails, &pod_kill?/1)
  end
  ...
  defp count_structure_kills(killmails) do
    ...
    Enum.count(killmails, fn km ->
      ...
      ship_type_id >= 35_000 && ship_type_id <= 40_000
    end)
  end
  ...
  defp detect_hotdrop_patterns(killmails) do
    ...
    hotdrop_count =
      ...
      |> Enum.count(fn {_time, kills} ->
        has_capitals = Enum.any?(kills, &capital_kill?/1)
