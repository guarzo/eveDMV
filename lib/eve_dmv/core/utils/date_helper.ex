defmodule EveDmv.Core.Utils.DateHelper do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> EveDmv.Core.Utils.DateHelper.get_year(dt)
      2024
  """
  ...
  ## Examples
      ...
      iex> dt = ~U[2024-03-15 10:30:00Z]
      iex> EveDmv.Core.Utils.DateHelper.get_month(dt)
      3
  """
  ...
  ## Examples
      ...
      iex> dt = ~U[2024-03-15 10:30:00Z]
      iex> EveDmv.Core.Utils.DateHelper.get_week_of_year(dt)
      11
  """
  ...
  ## Examples
      ...
      iex> dt = ~U[2024-03-15 10:30:00Z]
      iex> EveDmv.Core.Utils.DateHelper.get_day_of_year(dt)
      75
  """
  ...
  ## Examples
      ...
      iex> EveDmv.Core.Utils.DateHelper.leap_year?(2024)
      true

      iex> EveDmv.Core.Utils.DateHelper.leap_year?(2023)
      false
  """
  ...
  ## Examples
      ...
      iex> week_start = EveDmv.Core.Utils.DateHelper.start_of_week(dt)
  ...
  ## Examples
      ...
      iex> dt = ~U[2024-03-15 10:30:00Z]
      iex> EveDmv.Core.Utils.DateHelper.format_display(dt)
  ...
  ## Examples
      ...
      iex> EveDmv.Core.Utils.DateHelper.days_between(dt1, dt2)
      5
  """
