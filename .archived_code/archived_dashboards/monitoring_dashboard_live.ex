defmodule EveDmvWeb.MonitoringDashboardLive do
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
        ...
        <.metric_card
          ...
          value={"#{Float.round(@pipeline_metrics.messages.processed / max(1, DateTimeUtils.diff(DateTime.utc_now(), @pipeline_metrics.started_at, :minute)), 1)}/min"}
  ...
  defp format_relative_time(datetime) do
    minutes = DateTimeUtils.diff(DateTime.utc_now(), datetime, :minute)
  ...
  defp format_uptime(started_at) do
    hours = DateTimeUtils.diff(DateTime.utc_now(), started_at, :hour)

    cond do
      hours < 1 ->
        minutes = DateTimeUtils.diff(DateTime.utc_now(), started_at, :minute)
        "#{minutes}m"

      hours < 24 ->
        "#{hours}h #{rem(DateTimeUtils.diff(DateTime.utc_now(), started_at, :minute), 60)}m"
