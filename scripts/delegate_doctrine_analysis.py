#!/usr/bin/env python3
"""
Delegate doctrine analysis functions to DoctrineAnalysisEngine
"""
...
FUNCTIONS_TO_DELEGATE = [
    ("analyze_side_ship_composition", "DoctrineAnalysisEngine"),
    ("detect_doctrine_usage", "DoctrineAnalysisEngine"),
    ("calculate_logistics_ratio", "DoctrineAnalysisEngine"),
    ("detect_ewar_presence", "DoctrineAnalysisEngine"),
    ("identify_enemy_doctrine_patterns", "DoctrineAnalysisEngine"),
    ("generate_counter_strategies", "DoctrineAnalysisEngine"),
    ("calculate_counter_doctrine_priority", "DoctrineAnalysisEngine"),
]
...
if 'DoctrineAnalysisEngine' not in content:
    ...
    if match:
        ...
        new_alias = '  alias EveDmv.Contexts.CombatIntelligence.Domain.BattleAnalysis.Analyzers.DoctrineAnalysisEngine\n'
