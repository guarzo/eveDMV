#!/usr/bin/env python3
"""
Delegate battle comparison functions to BattleComparisonEngine
"""
...
FUNCTIONS_TO_DELEGATE = [
    ("identify_common_patterns", "BattleComparisonEngine"),
    ("analyze_tactical_evolution", "BattleComparisonEngine"),
]

# Backup the file
shutil.copy(FILE_PATH, FILE_PATH + ".backup_comparison")
...
if 'BattleComparisonEngine' not in content:
    ...
    if match:
        ...
        new_alias = '  alias EveDmv.Contexts.CombatIntelligence.Domain.BattleAnalysis.Analyzers.BattleComparisonEngine\n'
