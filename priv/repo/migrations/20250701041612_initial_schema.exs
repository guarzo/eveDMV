defmodule EveDmv.Repo.Migrations.InitialSchema do
  @moduledoc """
  ...
  def up do
    ...
    create index(:wh_vetting, [:vetting_requested_at])
    ...
    create index(:surveillance_notifications, [:notification_type],
             name: "notifications_type_idx"
           )

    create index(:surveillance_notifications, [:is_read], name: "notifications_read_idx")

    create index(:surveillance_notifications, [:user_id, :inserted_at],
    ...
    create unique_index(:player_stats, [:character_id],
             name: "player_stats_unique_character_index"
           )
    ...
    # Note: Cannot add foreign key to killmails_enriched due to composite primary key
    # The killmail_id column remains as-is without foreign key constraint
  ...
  def down do
    ...
    # Note: No foreign key constraint to drop since we couldn't create one
    # due to killmails_enriched having a composite primary key
    ...
    drop_if_exists unique_index(:player_stats, [:character_id],
                     name: "player_stats_unique_character_index"
                   )

    drop table(:player_stats)

    drop_if_exists unique_index(:ship_stats, [:ship_type_id],
                     name: "ship_stats_unique_ship_index"
                   )
    ...
    drop_if_exists index(:surveillance_notifications, [:user_id, :inserted_at],
                     name: "notifications_user_time_idx"
                   )

    drop_if_exists index(:surveillance_notifications, [:is_read], name: "notifications_read_idx")

    drop_if_exists index(:surveillance_notifications, [:notification_type],
                     name: "notifications_type_idx"
                   )

    drop_if_exists index(:surveillance_notifications, [:profile_id],
    ...
    drop_if_exists index(:wh_vetting, [:vetting_requested_at])
