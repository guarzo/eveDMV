defmodule EveDmv.Repo.Migrations.InitialTables do
  ...
  def up do
    ...
    create(index(:wh_vetting, [:created_at]))
    ...
    create(
      index(:surveillance_notifications, [:user_id, :created_at],
    ...
    alter table(:surveillance_profile_matches) do
      modify(
        :killmail_id,
        references(:killmails_enriched,
          column: :killmail_id,
          name: "surveillance_profile_matches_killmail_id_fkey",
          type: :bigint,
          prefix: "public"
        )
      )
    ...
    create table(:api_keys, primary_key: false) do
      ...
      add(:is_active, :boolean, null: false, default: true)
      add(:created_by_character_id, :bigint, null: false)
  ...
  def down do
    ...
    drop(
      constraint(:surveillance_profile_matches, "surveillance_profile_matches_killmail_id_fkey")
    )

    alter table(:surveillance_profile_matches) do
      modify(:killmail_id, :bigint)
    end
    ...
    drop_if_exists(index(:wh_vetting, [:created_at]))
