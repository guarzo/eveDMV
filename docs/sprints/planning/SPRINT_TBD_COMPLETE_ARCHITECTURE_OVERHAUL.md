...
- New feature development (except cross-system intelligence completion)
- UI/UX improvements (unless needed for testing)
- Business logic changes
- Database schema changes (except intelligence-related)
...
### **Intelligence Integration (Cross-cutting)**
*Complete TODO items from cross-system intelligence (10 TODOs)*

| Story ID | Description | Points | Priority | Definition of Done |
|----------|-------------|---------|----------|-------------------|
| INTEL-1A | Implement cross-system intelligence correlation | 8 | HIGH | Regional threat propagation with real data |
| INTEL-1B | Build constellation activity aggregation | 5 | MEDIUM | Multi-system activity correlation algorithms |
| INTEL-1C | Create regional trend analysis engine | 8 | MEDIUM | System topology-based trend detection |
| INTEL-1D | Implement threat propagation algorithms | 5 | LOW | Cross-system threat correlation with time decay |
| API-1A | Plan EVE ESI API integration architecture | 3 | LOW | Integration plan for character/corporation data |
| API-1B | Design external data processing pipeline | 5 | LOW | ETL pipeline for ESI data ingestion |

**Intelligence Integration Total**: 34 points

**Total Sprint Points**: 136 (Extended for comprehensive overhaul + intelligence completion)
...
### **Intelligence Integration (Throughout Sprint)**
*Integrate cross-system intelligence work with architecture changes*

**Week 1-2: Intelligence Foundation**
- Implement cross-system intelligence correlation during directory restructuring
- Build constellation activity aggregation after supervisor consolidation
- Ensure intelligence modules follow new architecture patterns

**Week 3-4: Intelligence Optimization**
- Optimize intelligence queries using new caching strategy
- Add intelligence-specific observability and monitoring
- Implement regional trend analysis with performance boundaries

**Intelligence Success Criteria:**
- [ ] Cross-system intelligence correlation works with real data
- [ ] Regional threat propagation algorithms implemented
- [ ] Constellation activity aggregation functional
- [ ] ESI API integration architecture planned
- [ ] All intelligence features follow new architecture patterns
