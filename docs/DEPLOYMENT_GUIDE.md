...
ADMIN_BOOTSTRAP_CHARACTERS=Character Name 1,Character Name 2
...
# Note: Static data loading is now handled by mix task:
# docker-compose -f docker-compose.production.yml exec app bin/eve_dmv eval "Mix.Task.run('eve.load_static_data')"
```
...
curl http://localhost:4000/admin/performance
```
